...
Builds the Karat Hive Admin Portal (apps/kh_admin) for Flutter Web.

Arguments:
  base_url             Base URL path prefix (default: /hive_admin/)

Options:
  --base-href <path>   Explicitly specify the base href (default: /hive_admin/)
...
echo "============================================================"
echo " Building Karat Hive Admin Portal for Web"
echo "============================================================"
