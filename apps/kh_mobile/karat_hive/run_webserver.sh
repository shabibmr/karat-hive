...
LATEST_LOG="${BUILD_DIR}/run_webserver.log"
TIMESTAMPED_LOG="${BUILD_DIR}/run_webserver_${TIMESTAMP}.log"
...
echo "============================================================"
echo " Running karat_hive on Web Server"
echo "============================================================"
echo " App Directory : ${APP_DIR}"
echo " Device        : web-server"
echo " Web Host      : ${WEB_HOST}"
echo " Web Port      : ${WEB_PORT} (http://${WEB_HOST}:${WEB_PORT}${BASE_HREF})"
...
# Run flutter on web-server and stream output to both console and log
