...
import 'package:karat_hive/core/firebase/firestore_config_service.dart';

void main() {
  group('FirestoreConfigService.parseApiBaseUrlForFlavor', () {
    ...
    test('returns null when document has no matching or fallback keys', () {
      final data = {
        'unrelated_key': 'value',
      };
