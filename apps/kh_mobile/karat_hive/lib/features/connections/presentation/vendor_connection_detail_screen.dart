...
class VendorConnectionDetailScreen extends ConsumerWidget {
  const VendorConnectionDetailScreen({super.key, required this.connectionId});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      key: const Key('vendor-connection-detail-screen'),
      appBar: AppBar(
