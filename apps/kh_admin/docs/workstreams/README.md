...
**Atomic task register** (all 9 streams broken into ~180 pick-up-cold tasks with files / action / deps / done-when, plus per-feature pipelines and an id-coverage checklist): [`task-register-v1.md`](task-register-v1.md).
