...
mixin _$TaxonomyNode {
 ...
 String get id; String get nameEn; String get nameAr; String? get icon; int get displayOrder; bool get isActive;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TaxonomyNode&&(identical(other.id, id) || other.id == id)&&(identical(other.nameEn, nameEn) || other.nameEn == nameEn)&&(identical(other.nameAr, nameAr) || other.nameAr == nameAr)&&(identical(other.icon, icon) || other.icon == icon)&&(identical(other.displayOrder, displayOrder) || other.displayOrder == displayOrder)&&(identical(other.isActive, isActive) || other.isActive == isActive));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nameEn,nameAr,icon,displayOrder,isActive);
...
@useResult
$Res call({
 String id, String nameEn, String nameAr, String? icon, int displayOrder, bool isActive
});
...
/// Create a copy of TaxonomyNode
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? nameEn = null,Object? nameAr = null,Object? icon = freezed,Object? displayOrder = null,Object? isActive = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String nameEn,  String nameAr,  String? icon,  int displayOrder,  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaxonomyNode() when $default != null:
return $default(_that.id,_that.nameEn,_that.nameAr,_that.icon,_that.displayOrder,_that.isActive);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String nameEn,  String nameAr,  String? icon,  int displayOrder,  bool isActive)  $default,) {final _that = this;
switch (_that) {
case _TaxonomyNode():
return $default(_that.id,_that.nameEn,_that.nameAr,_that.icon,_that.displayOrder,_that.isActive);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String nameEn,  String nameAr,  String? icon,  int displayOrder,  bool isActive)?  $default,) {final _that = this;
switch (_that) {
case _TaxonomyNode() when $default != null:
return $default(_that.id,_that.nameEn,_that.nameAr,_that.icon,_that.displayOrder,_that.isActive);case _:
  return null;
...
class _TaxonomyNode implements TaxonomyNode {
  const _TaxonomyNode({required this.id, required this.nameEn, required this.nameAr, this.icon, this.displayOrder = 0, this.isActive = true});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TaxonomyNode&&(identical(other.id, id) || other.id == id)&&(identical(other.nameEn, nameEn) || other.nameEn == nameEn)&&(identical(other.nameAr, nameAr) || other.nameAr == nameAr)&&(identical(other.icon, icon) || other.icon == icon)&&(identical(other.displayOrder, displayOrder) || other.displayOrder == displayOrder)&&(identical(other.isActive, isActive) || other.isActive == isActive));
}
...
/// Create a copy of TaxonomyNode
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? nameEn = null,Object? nameAr = null,Object? icon = freezed,Object? displayOrder = null,Object? isActive = null,}) {
