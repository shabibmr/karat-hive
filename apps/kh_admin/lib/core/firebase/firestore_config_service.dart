...
/// Service to dynamically retrieve remote environment configuration from Firestore for KhAdmin.
  ...
  Future<String?> fetchRemoteApiBaseUrl(
    ...
    try {
      ...
      if (!docSnapshot.exists) {
        logger.info('[FirestoreConfigService] app_config/environment does not exist.');
        return null;
      }
      ...
      logger.warning('[FirestoreConfigService] Timed out fetching remote environment config.');
      return null;
    } on Object catch (e, st) {
      logger.warning('[FirestoreConfigService] Error fetching remote environment config: $e', e, st);
      return null;
    }
  }
