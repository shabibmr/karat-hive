...
| **Source of truth** | [`docs/Requirements-Spec-v1.5.md`](Requirements-Spec-v1.5.md) · [`docs/adr/0001`–`0010`](adr/) · [`CONTEXT.md`](../CONTEXT.md) |
...
```mermaid
flowchart LR
    RAW["Requirements-raw.txt<br/><i>original brief</i>"] --> SRS["Requirements-Spec-v1.5.md<br/><i>what the system does</i>"]
...
| `taxonomy` | `REGION` (flat display/filter), vendor↔region link table (`CATEGORY` entity removed per ADR 0014) |
