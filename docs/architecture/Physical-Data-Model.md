...
| **Source of truth** | SRS v1.5 §5–§6 → Architecture-Backend §12 + Appendix B/C → [API-Route-Inventory](API-Route-Inventory.md). T36 deltas from [Async-Contract §10](Async-Contract.md) and [Screen-API-Map §6](Screen-API-Map.md) |
...
| `REGION` | `region` | `CATEGORY` entity removed per ADR 0014 |
| `GOLD_RATE` | `gold_rate` | |
