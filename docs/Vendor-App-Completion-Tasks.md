...
| **Status** | Working backlog — CP-2 Track A done; F06/B01 freezed mapping landed (`RatingSummary` still hand-rolled); remaining partial: F05 (ARB + formatters done; hard-coded-string lint still missing), I01 (T36 brief drafted, TL approval still required) |
