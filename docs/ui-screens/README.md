...
Screen-level field inventory derived from `docs/Requirements-Spec-v1.5.md` (Appendix C + §4 functional requirements + §6 entity dictionary). Domain language follows root `CONTEXT.md`.
...
- `docs/Requirements-Spec-v1.5.md` — Appendix C, §4, §5, §6, §7.1  
- `docs/Requirements-Spec-v1.5.md` §2.5 (C-10–C-13) + `docs/adr/0006`, `0007`, `0008` — stack constraints  
