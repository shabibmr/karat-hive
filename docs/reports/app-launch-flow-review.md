...
Status: **frozen consensus, captured 11 Sep 2026.** Working rule: [`docs/adr/0011-guest-first-landing.md`](../adr/0011-guest-first-landing.md). Screen: [`ui-screens/customer/CUS-S23-guest-landing.md`](../../ui-screens/customer/CUS-S23-guest-landing.md). Code not yet changed.  
