...
mixin _$NotificationDto {
 ...
 String get id; String get type; String get title; String get body; String get deepLink; bool get isCritical; DateTime? get readAt; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,type,title,body,deepLink,isCritical,readAt,createdAt);

@override
String toString() {
  return 'NotificationDto(id: $id, type: $type, title: $title, body: $body, deepLink: $deepLink, isCritical: $isCritical, readAt: $readAt, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String type, String title, String body, String deepLink, bool isCritical, DateTime? readAt, DateTime createdAt
});
...
/// Create a copy of NotificationDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? type = null,Object? title = null,Object? body = null,Object? deepLink = null,Object? isCritical = null,Object? readAt = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String type,  String title,  String body,  String deepLink,  bool isCritical,  DateTime? readAt,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationDto() when $default != null:
return $default(_that.id,_that.type,_that.title,_that.body,_that.deepLink,_that.isCritical,_that.readAt,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String type,  String title,  String body,  String deepLink,  bool isCritical,  DateTime? readAt,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _NotificationDto():
return $default(_that.id,_that.type,_that.title,_that.body,_that.deepLink,_that.isCritical,_that.readAt,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String type,  String title,  String body,  String deepLink,  bool isCritical,  DateTime? readAt,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _NotificationDto() when $default != null:
return $default(_that.id,_that.type,_that.title,_that.body,_that.deepLink,_that.isCritical,_that.readAt,_that.createdAt);case _:
  return null;
...
class _NotificationDto extends NotificationDto {
  const _NotificationDto({required this.id, required this.type, required this.title, required this.body, required this.deepLink, required this.isCritical, this.readAt, required this.createdAt}): super._();
...
/// Create a copy of NotificationDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? type = null,Object? title = null,Object? body = null,Object? deepLink = null,Object? isCritical = null,Object? readAt = freezed,Object? createdAt = null,}) {
