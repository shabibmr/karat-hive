...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,reference,requestType,direction,state,category,region,notes,weightGrams,weightIsApproximate,purityKarat,ornamentType,condition,denominationGrams,quantity,mintOrRefiner,budgetMin,budgetMax,budgetIsFlexible,indicativeValue,publishedAt,expiresAt,offerCount,unreadOfferCount,const DeepCollectionEquality().hash(media),createdAt,updatedAt,const DeepCollectionEquality().hash(gemstones),cancellationReason,acceptedOfferId,connectionId,const DeepCollectionEquality().hash(offers)]);

@override
String toString() {
  return 'CustomerRequestDto(id: $id, reference: $reference, requestType: $requestType, direction: $direction, state: $state, category: $category, region: $region, notes: $notes, weightGrams: $weightGrams, weightIsApproximate: $weightIsApproximate, purityKarat: $purityKarat, ornamentType: $ornamentType, condition: $condition, denominationGrams: $denominationGrams, quantity: $quantity, mintOrRefiner: $mintOrRefiner, budgetMin: $budgetMin, budgetMax: $budgetMax, budgetIsFlexible: $budgetIsFlexible, indicativeValue: $indicativeValue, publishedAt: $publishedAt, expiresAt: $expiresAt, offerCount: $offerCount, unreadOfferCount: $unreadOfferCount, media: $media, createdAt: $createdAt, updatedAt: $updatedAt, gemstones: $gemstones, cancellationReason: $cancellationReason, acceptedOfferId: $acceptedOfferId, connectionId: $connectionId, offers: $offers)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,reference,requestType,direction,state,category,region,notes,weightGrams,weightIsApproximate,purityKarat,ornamentType,condition,denominationGrams,quantity,mintOrRefiner,budgetMin,budgetMax,budgetIsFlexible,indicativeValue,publishedAt,expiresAt,offerCount,unreadOfferCount,const DeepCollectionEquality().hash(_media),createdAt,updatedAt,const DeepCollectionEquality().hash(_gemstones),cancellationReason,acceptedOfferId,connectionId,const DeepCollectionEquality().hash(_offers)]);
...
/// Create a copy of CustomerRequestDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? reference = freezed,Object? requestType = null,Object? direction = null,Object? state = null,Object? category = null,Object? region = null,Object? notes = freezed,Object? weightGrams = freezed,Object? weightIsApproximate = null,Object? purityKarat = freezed,Object? ornamentType = freezed,Object? condition = freezed,Object? denominationGrams = freezed,Object? quantity = freezed,Object? mintOrRefiner = freezed,Object? budgetMin = freezed,Object? budgetMax = freezed,Object? budgetIsFlexible = null,Object? indicativeValue = freezed,Object? publishedAt = freezed,Object? expiresAt = freezed,Object? offerCount = null,Object? unreadOfferCount = freezed,Object? media = null,Object? createdAt = null,Object? updatedAt = null,Object? gemstones = freezed,Object? cancellationReason = freezed,Object? acceptedOfferId = freezed,Object? connectionId = freezed,Object? offers = freezed,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,requestType,direction,categoryId,regionId,notes,const DeepCollectionEquality().hash(weightGrams),weightIsApproximate,purityKarat,ornamentType,condition,const DeepCollectionEquality().hash(denominationGrams),quantity,mintOrRefiner,const DeepCollectionEquality().hash(budgetMin),const DeepCollectionEquality().hash(budgetMax),budgetIsFlexible,const DeepCollectionEquality().hash(gemstones),const DeepCollectionEquality().hash(mediaKeys));

@override
String toString() {
  return 'RequestDraftInput(requestType: $requestType, direction: $direction, categoryId: $categoryId, regionId: $regionId, notes: $notes, weightGrams: $weightGrams, weightIsApproximate: $weightIsApproximate, purityKarat: $purityKarat, ornamentType: $ornamentType, condition: $condition, denominationGrams: $denominationGrams, quantity: $quantity, mintOrRefiner: $mintOrRefiner, budgetMin: $budgetMin, budgetMax: $budgetMax, budgetIsFlexible: $budgetIsFlexible, gemstones: $gemstones, mediaKeys: $mediaKeys)';
}
...
/// Create a copy of RequestDraftInput
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? requestType = freezed,Object? direction = freezed,Object? categoryId = freezed,Object? regionId = freezed,Object? notes = freezed,Object? weightGrams = freezed,Object? weightIsApproximate = freezed,Object? purityKarat = freezed,Object? ornamentType = freezed,Object? condition = freezed,Object? denominationGrams = freezed,Object? quantity = freezed,Object? mintOrRefiner = freezed,Object? budgetMin = freezed,Object? budgetMax = freezed,Object? budgetIsFlexible = freezed,Object? gemstones = freezed,Object? mediaKeys = freezed,}) {
  return _then(_self.copyWith(
...
switch (_that) {
case _RequestDraftInput() when $default != null:
return $default(_that.requestType,_that.direction,_that.categoryId,_that.regionId,_that.notes,_that.weightGrams,_that.weightIsApproximate,_that.purityKarat,_that.ornamentType,_that.condition,_that.denominationGrams,_that.quantity,_that.mintOrRefiner,_that.budgetMin,_that.budgetMax,_that.budgetIsFlexible,_that.gemstones,_that.mediaKeys);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,requestType,direction,categoryId,regionId,notes,const DeepCollectionEquality().hash(weightGrams),weightIsApproximate,purityKarat,ornamentType,condition,const DeepCollectionEquality().hash(denominationGrams),quantity,mintOrRefiner,const DeepCollectionEquality().hash(budgetMin),const DeepCollectionEquality().hash(budgetMax),budgetIsFlexible,const DeepCollectionEquality().hash(_gemstones),const DeepCollectionEquality().hash(_mediaKeys));
...
/// Create a copy of RequestDraftInput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? requestType = freezed,Object? direction = freezed,Object? categoryId = freezed,Object? regionId = freezed,Object? notes = freezed,Object? weightGrams = freezed,Object? weightIsApproximate = freezed,Object? purityKarat = freezed,Object? ornamentType = freezed,Object? condition = freezed,Object? denominationGrams = freezed,Object? quantity = freezed,Object? mintOrRefiner = freezed,Object? budgetMin = freezed,Object? budgetMax = freezed,Object? budgetIsFlexible = freezed,Object? gemstones = freezed,Object? mediaKeys = freezed,}) {
